...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        // ======================================================================== //
            ...
            jQuery("#bootstrap-shortcodes-help #complete-bootstrap-5-shortcodes").nextUntil("#bootstrap-shortcodes-help #bs-requirements").hide();
            ...
            <div class="modal-body ativa-scroll">
                <div>
                    ...
                    <?php
                        ...
                        $html = str_replace('<hr>', '<hr><a class="btn btn-link btn-default float-end" href="#bs-top"><i class="fas fa-long-arrow-alt-up text-muted"></i></a>', $html);
