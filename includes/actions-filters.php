...
// ======================================================================== // 
    ...
    function php_version_notice() {
        ...
        $message = __( '<strong>Bootstrap 5 Shortcodes for WordPress</strong> requires PHP version 5.3 or later. You are running PHP version ' . PHP_VERSION . '. Please upgrade to a supported version of PHP.', 'sample-text-domain' );
...
// ======================================================================== //
    ...
    function bootstrap_shortcodes_styles_all() {
        wp_register_style( 'bootstrap-shortcodes-help-all', plugins_url( 'complete-bootstrap-5-shortcodes/includes/help/css/bootstrap-shortcodes-help-all.css' ) );
...
// ======================================================================== // 
    ...
    {
        wp_register_style( 'bootstrap-shortcodes-help', plugins_url( 'complete-bootstrap-5-shortcodes/includes/help/css/bootstrap-shortcodes-help.css' ) );
        wp_register_script( 'bootstrap', plugins_url( 'complete-bootstrap-5-shortcodes/includes/help/js/bootstrap.min.js' ) );
        wp_register_script( 'popper', plugins_url( 'complete-bootstrap-5-shortcodes/includes/help/js/popper.min.js' ) );
        wp_register_style( 'fontawesome', plugins_url( 'complete-bootstrap-5-shortcodes/includes/help/css/fontawesome.min.css' ) );
