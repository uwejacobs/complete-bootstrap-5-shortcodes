# Complete Bootstrap 5 Shortcodes

![WordPress
Rating](https://img.shields.io/wordpress/plugin/r/complete-bootstrap-5-shortcodes.svg)
![WordPress
Downloads](https://img.shields.io/wordpress/plugin/dt/complete-bootstrap-5-shortcodes.svg)

WordPress plugin that provides shortcodes for easier use of the
Bootstrap styles and components in your content.

**Bootstrap 5 Shortcodes for WordPress** creates a simple, out of the
...
![Tested in
WordPress](https://img.shields.io/wordpress/v/complete-bootstrap-5-shortcodes.svg)
![PHP 5.3+](https://img.shields.io/badge/PHP-5.3%2B-blue.svg)
![Bootstrap](https://img.shields.io/badge/Bootstrap-5.0.x-6f5499.svg)
...
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------- | ------- |
| fluid     | Create a full width container, spanning the entire width of the viewport. (see [Bootstrap documentation](https://getbootstrap.com/docs/5.0/layout/containers/#fluid-containers) for details) | optional | 🚩 (flag) |         |
...
[Bootstrap responsive ratio helpers
documentation](https://getbootstrap.com/docs/5.0/helpers/ratio/)
...
documentation](https://getbootstrap.com/docs/5.0/utilities/display/#hiding-elements)
...
[Bootstrap card
documentation](https://getbootstrap.com/docs/5.0/components/card/)
...
[Bootstrap button
documentation](https://getbootstrap.com/docs/5.0/components/buttons/)
...
documentation](https://getbootstrap.com/docs/5.0/components/button-group/)
...
| Parameter | Description                                                                                                                                     | Required | Values   | Default |
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------- | ------- |
| end       | To end-align the menu with the button or link                                                                                                   | optional | 🚩 (flag) | (left)  |
| right     | Same functionality as `end` (for compatibility with V4)                                                                                         | optional | 🚩 (flag) | (left)  |
| class     | Any extra classes you want to add                                                                                                               | optional | any text | none    |
| data      | Data attribute and value pairs separated by a comma. Pairs separated by pipe. See example at [\[container\] parameters](#container-parameters). | optional | any text | none    |
...
documentation](https://getbootstrap.com/docs/5.0/components/dropdowns/)
...
documentation](https://getbootstrap.com/docs/5.0/components/navs-tabs/)
...
documentation](https://getbootstrap.com/docs/5.0/components/breadcrumb/)
...
| end       | Whether the badge should align to the end of its container                                                                                      | optional | 🚩 (flag)                                                                            |           |
| right     | Same as `end` for compatibility with V4                                                                                                         | optional | 🚩 (flag)                                                                            |           |
| class     | Any extra classes you want to add                                                                                                               | optional | any text                                                                            | none      |
| data      | Data attribute and value pairs separated by a comma. Pairs separated by pipe. See example at [\[container\] parameters](#container-parameters). | optional | any text                                                                            | none      |

[Bootstrap badge
documentation](https://getbootstrap.com/docs/5.0/components/badge/)
...
examples](https://getbootstrap.com/docs/5.0/examples/jumbotron/)
...
[Bootstrap alert
documentation](https://getbootstrap.com/docs/5.0/components/alerts/)
...
documentation](https://getbootstrap.com/docs/5.0/components/progress/)
...
documentation](https://getbootstrap.com/docs/5.0/utilities/flex/#media-object)
...
documentation](https://getbootstrap.com/docs/5.0/components/list-group/)
...
[Bootstrap code
documentation](https://getbootstrap.com/docs/5.0/content/reboot/#inline-code)
...
| responsive | Wrap the table in a div with the class "table-responsive" (see [Bootstrap responsive table documentation](https://getbootstrap.com/docs/5.0/content/tables/#responsive-tables)) | optional | 🚩 (flag) |         |
| class      | Any extra classes you want to add                                                                                                                                               | optional | any text | none    |
| data       | Data attribute and value pairs separated by a comma. Pairs separated by pipe. See example at [\[container\] parameters](#container-parameters).                                 | optional | any text | none    |

[Bootstrap table
documentation](https://getbootstrap.com/docs/5.0/content/tables/)
...
[Bootstrap images
documentation](https://getbootstrap.com/docs/5.0/content/images/)
...
[Bootstrap figures
documentation](https://getbootstrap.com/docs/5.0/content/figures/)
...
documentation](https://getbootstrap.com/docs/5.0/content/typography/#blockquotes)
...
[Bootstrap lead
documentation](https://getbootstrap.com/docs/5.0/content/typography/#lead)
...
documentation](https://getbootstrap.com/docs/5.0/utilities/borders/)
...
documentation](https://getbootstrap.com/docs/5.0/utilities/colors/)
...
[Bootstrap flex
documentation](https://getbootstrap.com/docs/5.0/utilities/flex/)
...
[Bootstrap tooltip
documentation](https://getbootstrap.com/docs/5.0/components/tooltips/)
...
[Bootstrap popovers
documentation](https://getbootstrap.com/docs/5.0/components/popovers/)
...
| Parameter | Description                                                                                                       | Required | Values   | Default |
| --------- | ----------------------------------------------------------------------------------------------------------------- | -------- | -------- | ------- |
| flush     | Remove some borders and rounded corners to render accordion items edge-to-edge in a parent container (e.g. cards) | optional | 🚩 (flag) |         |
| class     | Any extra classes you want to add.                                                                                | optional | any text |         |
| data      | Data attribute and value pairs separated by a comma. Pairs separated by pipe.                                     | optional | any text |         |

[Bootstrap collapse
documentation](https://getbootstrap.com/docs/5.0/components/collapse/)
...
[Bootstrap carousel
documentation](https://getbootstrap.com/docs/5.0/components/carousel/)
...
[Bootstrap modal
documentation](https://getbootstrap.com/docs/5.0/components/modal/)
